...
export const listIndividualProject: Portfolio[] = [
  ...
  },
  {
    ...
    demoLink:
      "https://sam21dr2.000webhostapp.com/SlidingPuzzle/layout/index.html",
  },
  {
    id: "snake",
    title: "Snake",
...
export const thesisProject: Portfolio = {
  ...
  description: `This is my thesis project.
    ...
    We made our thesis along with my internship.
    ...
    We build this using NextJS as front end framework, ASP.NET for back end, Postgresql, Nswag, etc.`,
  credentials: [
    {
      username: "admin",
      password: "123",
